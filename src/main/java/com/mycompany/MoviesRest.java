...
public class MoviesRest {
    ...
    @See(href = "endpoint/moviefun-rest/GET/movies/count", format = "html", value = "GET /movies/count")
    ...
    @Path("/")
    @ErrorMappings({
        @ErrorMapping(statusCode = 403, type = EJBAccessException.class, bodyResolver = "exceptionMessage")
    })
    @Category({"CRUD"})
    @ApiVersion({"1.0"})
    ...
    @See(href = "endpoint/moviefun-rest/GET/movies/", format = "html", value = "GET /movies")
    ...
    @Path("/{id}")
    @ErrorMappings({
        @ErrorMapping(statusCode = 404, type = EntityNotFoundException.class, bodyResolver = "exceptionMessage")
    })
    @Category({"CRUD"})
    @ApiVersion({"1.0"})
    @Tag({"Read","Search","Movies"})
